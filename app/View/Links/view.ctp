    ...
    echo $this->Form->create('Link', array(
        'url'=>array('controller'=>'Links', 'action'=>'edit', $this->request->data['Link']['id']),
		...
		<div class="col-md-6">
            <div class="form-group">
                ...
                echo $this->Form->input('permission_level', array(
                    ...
                    'class'=>'form-control chzn-select',
                    'empty' => false,
					'value'=>$this->request->data['Link']['permission_level'],
