...
<div class="modal-header modal-header-warning bg-orange">
	<a class="close" data-dismiss="modal"><i class="fa fa-close fa-2x"></i></a>
  	<h2><?=$this->request->data['User']['first_name']?> <?=$this->request->data['User']['last_name']?></h2>
</div>

<div class="modal-body">
    <div class="tabbable bg-white" style="margin-top: 20px;">
        <ul class="nav nav-tabs">
            <li class="<?=$personalClass?>"><a href="#user_info" data-toggle="tab"><i class="fa fa-address-card-o fa-fw" aria-hidden="true"></i> Personal</a></li>
            <li class="<?=$recordsClass?>"><a href="#user_records" data-toggle="tab"><i class="fa fa-book fa-fw" aria-hidden="true"></i> Training</a></li>
			<li class="<?=$testingClass?>"><a href="#user_testing" data-toggle="tab"><i class="fa fa-clipboard fa-fw" aria-hidden="true"></i> Testing</a></li>
            <!--<li class="<?=$assetsClass?>"><a href="#assets" data-toggle="tab"><i class="fa fa-car fa-fw" aria-hidden="true"></i> Assets</a></li>-->
            <li class="<?=$awardClass?>"><a href="#user_award" data-toggle="tab"><i class="fa fa-trophy fa-fw" aria-hidden="true"></i> Awards</a></li>
            <li class="<?=$safetyClass?>"><a href="#user_safety" data-toggle="tab"><i class="fa fa-ambulance fa-fw" aria-hidden="true"></i> Safety</a></li>
        </ul>

        <div class="tab-content">
            <div class="tab-pane fade <?=$personalClass?> in" id="user_info">
            ...
            <div class="tab-pane fade <?=$recordsClass?> in" id="user_records">
				<div class="tabbable" style="padding: 0px;">
                    <ul class="nav nav-pills">
                        <li class="active"><a href="#requiredTrn" data-toggle="tab" id="user_requiredLink"><i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i> Required Training</a></li>
                        <li><a href="#allTrn" data-toggle="tab" id="user_allLink"><i class="fa fa-book fa-fw" aria-hidden="true"></i>All Training</a></li>
                    </ul>

                    <div class="tab-content" style="border: 0px;">
                    	<div id="user_LoadingDiv" style="display:none;">
                        	<?php echo $this->Html->image('ajax-loader-red.gif'); ?>
                    	</div>
                        <div class="tab-pane fade active in" id="requiredTrn">
                            
						</div>
						<div class="tab-pane fade" id="allTrn">
			...
			-->
            <div class="tab-pane fade <?=$safetyClass?> in" id="user_safety">
                <table class="table table-striped table-condensed" id="assetsTable">
                    <thead>
                        <tr class="tr-heading">
			...
			<div class="tab-pane fade <?=$testingClass?> in" id="user_testing">
			...
			<div class="tab-pane fade <?=$awardClass?> in" id="user_award">
        ...
        jQuery(document).ready( function($) {
            ...
            $.ajax({
                    ...
                    beforeSend: function(xhr) {
                        ...
                        $('#user_LoadingDiv').show();
                    	$('#requiredTrn').empty();
                    },
                    success: function(response) {
                        console.log(response);
                        $('#requiredTrn').html(response);
                    },
			...
			$('#user_requiredLink').on('click', function () {
				$.ajax({
                    type: 'post',
                    url: '<?=$getRecord?>/required/<?=$this->request->data['User']['id']?>' + '.json',
                    dataType: "html",
			...
			$('#user_allLink').on('click', function () {
				$.ajax({
                    type: 'post',
