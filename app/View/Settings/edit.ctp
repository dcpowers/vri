<?php
    echo $this->Form->create($index, array(
        'url' => array('controller'=>'Settings', 'action'=>'edit', $saveType, $records[$index]['id']),
        'role'=>'form',
		'type'=>'file',
	...
	echo $this->Form->hidden('id', array('value'=>$records[$index]['id'])); 
?>
