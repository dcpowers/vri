<p>You have been scheduled for: <?=$name?>. In order to participate in this, you will need to log in to One System. You will see the items that you are scheduled for on your dashboard when you first log in.</p>
<ol>
