    ...
    <div class="row">
				<div class="col-sm-6 col-md-12">
			    	<div class="thumbnail">
			            ...
			            echo $this->Html->image($image, array('class'=>'img-circle img-responsive thumbnail', 'alt'=>$current_user['last_name']));
			            ?>
			      		<div class="caption">
			        		<h3><?=$this->request->data['User']['first_name']?> <?=$this->request->data['User']['last_name']?></h3>
			        		<dl>
				                <dt>Status:</dt>
