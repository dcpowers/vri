...
echo $this->Form->create('JobQuestion', array(
    'url' => array('controller'=>'jobQuestions', 'action'=>'edit', 'member'=>true), 
    'role'=>'form',
    'inputDefaults' => array(
        'label' => false,
        'div' => false,
...
echo $this->Form->hidden('id', array('value'=>$jobQuestion[0]['JobQuestion']['id']));

?>
<div class="container">
    <h2 class="title">Edit Screening Questions</h2>
    ...
    <div class="form-group">
        ...
        echo $this->Form->input('name', array (
            ...
            'value'=>$jobQuestion[0]['JobQuestion']['name']
        ));
        ?>
    </div>
