...
<div class="modal-body">
    ...
    echo $this->Form->create('TestGroup', array(
        'url' => array('controller'=>'TestGroups', 'action'=>'addSub', 'member'=>true), 
        'role'=>'form',
    ...
    if($category_type == 4){
        for($i=0;$i<=4;$i++){
            echo $this->Form->input($i.'.TestGroup.parent_id', array (
                'type'=>'hidden',
                'id'=>'parent_id',
                'value'=>$parent_id
            ));
            echo $this->Form->input($i.'.TestGroup.category_type', array (
                'type'=>'hidden',
                'id'=>'category_type',
                'value'=>$category_type
            ));
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <?php 
                        echo $this->Form->input($i.'.TestGroup.name', array (
                            'type'=>'text',
                            'placeholder' => 'Answer',
                            'id'=>'name',
                            'class'=>'form-control'
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label class="control-label" for="name">Answer:</label>
                        <?php 
                        echo $this->Form->input($i.'.TestGroup.description', array (
                            'type'=>'text',
