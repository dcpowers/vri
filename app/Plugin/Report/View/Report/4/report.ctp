...
<div class="container">
    ...
    if(!isset($ext[2]) || $ext[2] != 'pdf'){
        ...
        <div class="pull-right hideLink">
            ...
            echo $this->Html->image("pdfPrint.gif", array(
                ...
                'width'=>'48px',
                'height'=>'48px',
                'url' => array('plugin'=> 'report', 'controller' => 'report', 'action' => 'employeeClimateSurvey', $id, $is_blind, 'member'=>false, 'ext'=>'pdf'),
            ));                    
            ?>
        </div>
        <?php
    ...
    <div class="clearfix"></div>
        <div class="widget widget-no-header">
            ...
            <h1 class="text-center" style="text-align: center;"><?=$groupName?></h1>
            <div style="color:#428BCA; background-color:#428BCA;height:25px;"></div>
