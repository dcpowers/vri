...
class TestSchedulesController extends AppController {
    ...
    public function member_delete($id=null, $return_id=null){
    ...
    public function member_Single($id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            $creditCost = $test_credit[$this->request->data['AssignedTest']['test_id']];
            ...
            if($creditCount == 0){
                ...
                return $this->redirect(array('controller'=>'tests','action' => 'view_single', 'member'=>true, $id));    
            }
    ...
    public function member_Group($id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
    ...
    public function member_Group_add($id=null, $schedule_id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
            $id=$this->request->data['TestSchedule']['test_id'];
    ...
    public function member_Type($id=null){
        $title = "Select Type";
    ...
    public function member_MultiplePeople($id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
            $supervisorOf_id = Set::extract( AuthComponent::user(), '/SupervisorOf/id' );
    ...
    public function member_MultiplePeople_add($id=null, $schedule_id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
            $supervisorOf_id = Set::extract( AuthComponent::user(), '/SupervisorOf/id' );
    ...
    public function member_Blind($id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
            $id=$this->request->data['TestSchedule']['test_id'];
    ...
    public function member_scheduleByUser($id=null){
        if ($this->request->is('post') || $this->request->is('put')) {
            //Get number of credits needed for that test
            $test_credit = $this->Test->find('list', array(
                'conditions' => array(
    ...
    public function member_deleteByUser($id = null) {
    ...
    public function member_userDelete($id = null, $user_id = null, $return_id=null) {
        $this->AssignedTest->id = $id;
        //Get number of Credits
        $assigned = $this->AssignedTest->find('all', array(
            'conditions' => array(
    ...
    public function member_singleUserDelete($id = null, $user_id = null, $return_id=null) {
        $this->AssignedTest->id = $id;
        if($this->AssignedTest->delete()){
